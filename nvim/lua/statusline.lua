...
local vcs = function()
	...
	local added = git_info.added
			and ("%#StatusLineGitSignsAdd#" .. Utils.icons.git.added .. " " .. git_info.added .. " ")
		or ""
	local changed = git_info.changed
			and ("%#StatusLineGitSignsChange#" .. Utils.icons.git.changed .. " " .. git_info.changed .. " ")
		or ""
	local removed = git_info.removed
			and ("%#StatusLineGitSignsDelete#" .. Utils.icons.git.deleted .. " " .. git_info.removed .. " ")
		or ""
